...
class WebAppTests(unittest.TestCase):
    ...
    def test_frontend_is_local_and_responsive(self):
        ...
        self.assertIn("Pronunciation Dictionary · SHION", combined)
        self.assertIn("Voice Artifact Index", combined)
        ...
        self.assertIn("AUTOMATIC PROMOTION OFF", combined)
        self.assertIn("data-memory-action", combined)
        self.assertIn("Hard Delete is permanent", combined)
        self.assertIn("/api/memory", combined)
        self.assertIn("History omitted", combined)
        self.assertIn("Stop reason", combined)
        self.assertIn("Memory retrieval", combined)
